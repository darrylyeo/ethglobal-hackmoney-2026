...
execute one spec): all 11 AC re-verified in code; test:unit 41 Deno + 101 Vitest passed. Re-verification 2026-02-05 (PROMPT_build one spec): queryClient and all nine collections confirmed; networks.spec.ts, coins.spec.ts, actors.spec.ts, actor-coins.spec.ts present; test:unit passed.
