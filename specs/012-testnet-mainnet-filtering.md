...
Routes and balances refetch when filter changes. Re-verification 2026-02-05 (PROMPT_build one spec): all 6 AC re-verified—filtering in UnifiedBridgeFlow.svelte, AccountsSelect.svelte, CctpBridgeFlow; chain reset $effect in UnifiedBridgeFlow and AccountsSelect; persistence via bridgeSettingsState (PersistedState); default isTestnet: false in defaultBridgeSettings. test:unit 41 Deno + 101 Vitest passed; e2e bridge-e2e testnet/mainnet toggle scenarios passed. Re-verification 2026-02-05 (PROMPT_build execute one spec): all 6 AC re-confirmed in code; test:unit 41 Deno + 101 Vitest passed; e2e wallet + bridge-e2e testnet/mainnet tests (3) passed. Re-verification 2026-02-05 (PROMPT_build one spec, no incomplete specs): re-verified 012; all 6 AC confirmed (filteredNetworks in UnifiedBridgeFlow, AccountsSelect, CctpBridgeFlow; chain reset $effect; bridgeSettingsState persistence; default isTestnet: false); test:unit 41 Deno + 101 Vitest passed; e2e bridge-e2e testnet/mainnet toggle scenarios (3) passed. Re-verification 2026-02-05 (PROMPT_build execute one spec, no INCOMPLETE specs): re-verified 012; all 6 AC in code (filteredNetworks, chain reset $effect, PersistedState, default isTestnet false); test:unit 41 Deno + 101 Vitest passed; e2e bridge-e2e testnet/mainnet tests (toggle filters chains, switching resets selections) passed. Re-verification 2026-02-05 (PROMPT_build execute one spec): all 6 AC re-verified in UnifiedBridgeFlow, Accounts.svelte, CctpBridgeFlow (filteredNetworks); chain reset $effect; bridgeSettingsState PersistedState; defaultBridgeSettings isTestnet: false; test:unit 41 Deno + 101 Vitest passed; e2e bridge-e2e.test.ts testnet/mainnet toggle (2 tests) passed.
