...
Boundary for errors; GraphScene updated for symbol+period $id. Re-verification 2026-02-05 (PROMPT_build): all 7 acceptance criteria confirmed (route, USDC/ETH, period selector 1h–7d, TanStack DB/Voltaire, nodes/edges, chain in viz, svelte:boundary); test:unit passed. Re-verification 2026-02-05 (execute one spec): AC re-confirmed in coin/[symbol]/+page.svelte, +page.ts, transfer-graphs.ts, LiveTransfers.svelte, TIME_PERIODS in transfers-indexer.ts; test:unit 41 Deno + 101 Vitest passed. Re-verification 2026-02-05 (PROMPT_build execute one spec): all 7 AC re-verified (route /coin/[symbol], USDC/ETH, period selector 1h–7d, TanStack DB/Voltaire, nodes/edges in LiveTransfers, chainColor(node.chainIds), Boundary Failed snippet); test:unit 41 Deno + 101 Vitest passed. Re-verification 2026-02-05 (PROMPT_build.md execute one spec, no incomplete specs): re-verified 006; all 7 AC confirmed in +page.svelte, +page.ts, transfer-graphs.ts, LiveTransfers.svelte, TIME_PERIODS; test:unit 41 Deno + 101 Vitest passed. Re-verification 2026-02-05 (PROMPT_build execute one spec): no incomplete specs; re-verified 006; all 7 AC (route /coin/[symbol], USDC/ETH, period selector 1h–7d, TanStack DB/Voltaire, nodes/edges, chainColor(node.chainIds), Boundary Failed); test:unit 41 Deno + 101 Vitest passed.
