...
import { ChainId } from './chain-ids.ts'
export { ChainId } from './chain-ids.ts'
...
export const networks: readonly Network[] = [
	{
		...
		nativeCurrency: { name: 'Ether', symbol: 'ETH', coinId: CoinId.ETH, decimals: 18 },
	...
	},
	{
		...
		name: 'XDC',
		type: NetworkType.Mainnet,
		nativeCurrency: { name: 'XDC', symbol: 'XDC', coinId: CoinId.XDC, decimals: 18 },
	...
	},
	{
		...
		name: 'Unichain',
		type: NetworkType.Mainnet,
		nativeCurrency: { name: 'Unichain', symbol: 'UNI', coinId: CoinId.UNI, decimals: 18 },
	...
	},
	{
		...
		name: 'Polygon PoS',
		type: NetworkType.Mainnet,
		nativeCurrency: { name: 'MATIC', symbol: 'MATIC', coinId: CoinId.MATIC, decimals: 18 },
	...
	},
	{
		...
		name: 'Sonic',
		type: NetworkType.Mainnet,
		nativeCurrency: { name: 'S', symbol: 'S', coinId: CoinId.S, decimals: 18 },
	...
	},
	{
		...
		name: 'Sei Testnet',
		type: NetworkType.Testnet,
		nativeCurrency: { name: 'SEI', symbol: 'SEI', coinId: CoinId.SEI, decimals: 18 },
	...
	},
	{
		...
		name: 'Celo',
		type: NetworkType.Mainnet,
		nativeCurrency: { name: 'CELO', symbol: 'CELO', coinId: CoinId.CELO, decimals: 18 },
	...
	},
	{
		...
		name: 'Avalanche Fuji',
		type: NetworkType.Testnet,
		nativeCurrency: { name: 'AVAX', symbol: 'AVAX', coinId: CoinId.AVAX, decimals: 18 },
	...
	},
	{
		...
		name: 'EDU Chain',
		type: NetworkType.Mainnet,
		nativeCurrency: { name: 'EDU', symbol: 'EDU', coinId: CoinId.EDU, decimals: 18 },
	...
	},
	{
		...
		name: 'Mitosis',
		type: NetworkType.Mainnet,
		nativeCurrency: { name: 'MITO', symbol: 'MITO', coinId: CoinId.MITO, decimals: 18 },
	...
	},
	{
		...
		name: 'TAC',
		type: NetworkType.Mainnet,
		nativeCurrency: { name: 'TAC', symbol: 'TAC', coinId: CoinId.TAC, decimals: 18 },
