...
import { FetchTypeKind, IconKind, IconTarget } from './icons'
...
export const chainIconAliases = [
	{ target: IconTarget.Chain, fromId: ChainId.XDCApothem, toId: ChainId.XDC },
	{
		target: IconTarget.Chain,
	...
	{ target: IconTarget.Chain, fromId: ChainId.SeiTestnet, toId: ChainId.Sei },
	{
		target: IconTarget.Chain,
		fromId: ChainId.ArbitrumSepolia,
		toId: ChainId.Arbitrum,
	},
	{ target: IconTarget.Chain, fromId: ChainId.CeloSepolia, toId: ChainId.Celo },
	{
		target: IconTarget.Chain,
		fromId: ChainId.AvalancheFuji,
		toId: ChainId.Avalanche,
	},
	{ target: IconTarget.Chain, fromId: ChainId.BaseSepolia, toId: ChainId.Base },
	{
		target: IconTarget.Chain,
		fromId: ChainId.LineaSepolia,
		toId: ChainId.Linea,
	},
	{ target: IconTarget.Chain, fromId: ChainId.InkTestnet, toId: ChainId.Ink },
	{
		target: IconTarget.Chain,
