...
import { normalizeUniswapPool, type UniswapPool } from './uniswap-pools-normalize.ts'

Deno.test('normalizeUniswapPool returns pool with bigint sqrtPriceX96 and liquidity', () => {
