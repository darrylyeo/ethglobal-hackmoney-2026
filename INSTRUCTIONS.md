Write a minimal interface to drive the LI.FI SDK and USDC bridging across all
supported chains
...
- Tabs
- No semicolons
- For constants, make a `.ts` file for each entity type abd export TypeScript
  enums as IDs and associated mapping objects for values
  ```typescript
  // networks.ts
